...
export const LOAD_ORDER_LIST_FAILURE = 'LOAD_ORDER_LIST_FAILURE@Lecturer';
export const LOAD_ORDER_LIST_REQUEST = 'LOAD_ORDER_LIST_REQUEST@Lecturer';
export const LOAD_ORDER_LIST_SUCCESS = 'LOAD_ORDER_LIST_SUCCESS@Lecturer';
export const OPEN_ORDER_INFO = 'OPEN_ORDER_INFO@Lecturer';
