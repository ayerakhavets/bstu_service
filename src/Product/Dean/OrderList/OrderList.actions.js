...
export const LOAD_ORDER_LIST_FAILURE = 'LOAD_ORDER_LIST_FAILURE@Dean';
export const LOAD_ORDER_LIST_REQUEST = 'LOAD_ORDER_LIST_REQUEST@Dean';
export const LOAD_ORDER_LIST_SUCCESS = 'LOAD_ORDER_LIST_SUCCESS@Dean';
export const OPEN_ORDER_INFO = 'OPEN_ORDER_INFO@Dean';
